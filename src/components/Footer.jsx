        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <Link to="/" className="inline-block mb-4">
              <span className="text-2xl font-bold text-white">A-1 Spotless</span>
            </Link>
            ...
            <p className="text-gray-400">
              <strong>License #:</strong> 13VH006650000
            </p>
          </div>
          ...
          {/* Commercial Services & Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-4">Commercial Services</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="w-5 h-5 text-primary mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path>
                </svg>
                <span className="text-gray-400">Bridgewater, NJ</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-primary mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                </svg>
                <a href="tel:9086479274" className="text-gray-400 hover:text-white transition-colors">
                  (908) 647-9274
                </a>
              </li>
              <li className="flex items-start">
                ...
                <a href="mailto:info@a-1spotless.com" className="text-gray-400 hover:text-white transition-colors">
                  info@a-1spotless.com
                </a>
              </li>
            </ul>
